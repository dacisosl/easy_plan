...
/**
 * 1-1. 학사일정 — 2026학년도 2학기 21주 (학교 실제 일정).
 *
 * 8.13.(목) 개학 ~ 12.31.(목) 방학식.
 * 정기시험: 1회 10.6.~8.(9주) · 2회 12.7.~10.(18주).
 * 세부는 관리자 모드에서 고쳐 게시하는 것을 전제로 한다.
 */
export const WEEKS_2026_2: Week[] = [
  W(1, '2026-08-10', '2026-08-14', 2, { events: ['개학식(8.13.)'] }),
  W(2, '2026-08-17', '2026-08-21', 4, { events: ['광복절 대체공휴일(8.17.)'] }),
  W(3, '2026-08-24', '2026-08-28', 5),
  W(4, '2026-08-31', '2026-09-04', 5, {
    events: ['대수능모의고사(3학년)·전국연합학력평가(1·2학년)(9.2.)'],
  }),
  W(5, '2026-09-07', '2026-09-11', 5),
  W(6, '2026-09-14', '2026-09-18', 5),
  W(7, '2026-09-21', '2026-09-25', 3, { events: ['추석 연휴(9.24.~26.)'] }),
  W(8, '2026-09-28', '2026-10-02', 5),
  W(9, '2026-10-05', '2026-10-09', 3, {
    events: ['개천절 대체공휴일(10.5.)', '2학기 1회고사(10.6.~8.)', '한글날(10.9.)'],
    is_exam: true,
  }),
  W(10, '2026-10-12', '2026-10-16', 5),
  W(11, '2026-10-19', '2026-10-23', 5, { events: ['전국연합학력평가(10.20.)'] }),
  W(12, '2026-10-26', '2026-10-30', 5),
  W(13, '2026-11-02', '2026-11-06', 5),
  W(14, '2026-11-09', '2026-11-13', 5),
  W(15, '2026-11-16', '2026-11-20', 3, {
    events: ['재량휴업일 — 대학수학능력시험(11.19.)', '재량휴업일(11.20.)'],
  }),
  W(16, '2026-11-23', '2026-11-27', 5),
  W(17, '2026-11-30', '2026-12-04', 5),
  W(18, '2026-12-07', '2026-12-11', 5, {
    events: ['2학기 2회고사(12.7.~10.)', '3학년 현장체험학습(12.8.)'],
    is_exam: true,
  }),
  W(19, '2026-12-14', '2026-12-18', 5),
  W(20, '2026-12-21', '2026-12-24', 4, { events: ['성탄절(12.25.)'] }),
  W(21, '2026-12-28', '2026-12-31', 4, {
    events: ['축제 및 동아리 한마당(12.28.)', '방학식(12.31.)'],
  }),
]
...
export const SCHOOL_SEED: SchoolLayer = {
  ...
  rules: {
    ...
    // 새 계획서가 시작하는 학기 — 학기가 바뀌면 관리자가 바꿔 게시한다
    default_semester: 2,
